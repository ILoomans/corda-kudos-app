...
@InitiatingFlow(protocol = "finalize-vote-protocol")
class FinalizeVoteSubFlow(private val signedTransaction: UtxoSignedTransaction, private val otherMember: MemberX500Name): SubFlow<String> {
...
@InitiatedBy(protocol = "finalize-vote-protocol")
class FinalizeVoteResponderFlow: ResponderFlow {
